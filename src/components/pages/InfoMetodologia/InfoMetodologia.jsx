  ...
  return (
    <>
      ...
      <div className='infoContainer'>
        ...
        <p className="infoMetodology">La OSO en la educación media académica trabaja con jóvenes estudiantes de los últimos tres grados escolares (9º, 10º y 11º), ya 
